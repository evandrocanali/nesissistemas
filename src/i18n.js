...
const resources = {
  PT: {
    translation: {
      ...
      "footer": {
        ...
        "contact": "Contato",
        "rights": "NRE Solutions. Todos os direitos reservados. Feito com tecnologia de ponta."
      },
      "contact": {
      ...
      "sobre": {
        ...
        "diff": "A Diferença NRE Solutions", "diff_desc": "Não somos apenas programadores. Somos engenheiros e arquitetos de soluções. Nosso time respira inovação e garantimos que todo código entregue siga rigorosos padrões globais de qualidade e segurança.",
  ...
  EN: {
    translation: {
      ...
      "sobre": { "title": "Our Essence", "mission": "Mission", "mission_desc": "Democratizing access to cutting-edge technology, enabling companies to compete through excellent software.", "diff": "The NRE Solutions Difference", "diff_desc": "We are architects. We guarantee rigorous global quality and security standards.", "tech": "Technologies We Master" },
  ...
  FR: {
    translation: {
      ...
      "footer": { "desc": "Des systèmes conçus pour demain.", "s_title": "Solutions", "s1": "Web", "s2": "Mobile", "s3": "Sites", "s4": "E-commerce", "c_title": "Entreprise", "c1": "À propos", "c2": "Succès", "c3": "Carrières", "c4": "Blog", "contact": "Contact", "rights": "NRE Solutions. Tous droits réservés." },
  ...
  DE: {
    translation: {
      ...
      "footer": { "desc": "Zukunftsweisende Systeme und Apps.", "s_title": "Lösungen", "s1": "Web", "s2": "Apps", "s3": "Websites", "s4": "Shop", "c_title": "Firma", "c1": "Über uns", "c2": "Erfolge", "c3": "Karriere", "c4": "Blog", "contact": "Kontakt", "rights": "NRE Solutions. Alle Rechte vorbehalten." },
  ...
  ZH: {
    translation: {
      ...
      "footer": { "desc": "为明天设计的高影响力软件、系统和移动平台。", "s_title": "解决方案", "s1": "Web系统", "s2": "移动应用", "s3": "企业网站", "s4": "电子商务", "c_title": "公司", "c1": "关于我们", "c2": "成功案例", "c3": "职业", "c4": "博客", "contact": "联系", "rights": "NRE Solutions。版权所有。" },
  ...
  HI: {
    translation: {
      ...
      "footer": { "desc": "कल के लिए डिज़ाइन किए गए सॉफ्टवेयर और ऐप्स।", "s_title": "समाधान", "s1": "वेब सिस्टम", "s2": "मोबाइल ऐप्स", "s3": "कॉर्पोरेट साइट्स", "s4": "ई-कॉमर्स", "c_title": "कंपनी", "c1": "हमारे बारे में", "c2": "सफलता की कहानियां", "c3": "करियर", "c4": "ब्लॉग", "contact": "संपर्क", "rights": "NRE Solutions। सर्वाधिकार सुरक्षित।" },
      ...
      "sobre": { "title": "हमारा सार", "mission": "मिशन", "mission_desc": "अत्याधुनिक तकनीक के उपयोग को सभी के लिए संभव बनाना।", "diff": "NRE Solutions का अंतर", "diff_desc": "हम तकनीकी गुणवत्ता और सुरक्षा सुनिश्चित करते हैं।", "tech": "हमारी तकनीकें" },
